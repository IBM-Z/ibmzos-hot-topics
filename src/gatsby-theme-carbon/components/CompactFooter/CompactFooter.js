...
import { Row, Column, Grid } from 'gatsby-theme-carbon';
import {
    compactFooter,
    grid,
    nav,
            ...
            <Column colLg={8} colMd={8}>
              <ul className={nav}>
                    <li className={listItem}>
                      <a href="https://www.ibm.com/contact/us/en/?lnk=flg-cont-usen" aria-label="Contact IBM">
                        Contact IBM
                      </a>
                    </li>
                    <li className={listItem}>
                      <a href="https://www.ibm.com/privacy/us/en/?lnk=flg-priv-usen" aria-label="Privacy">
                      Privacy
                      </a>
                    </li>
                    <li className={listItem}>
                      <a href="https://www.ibm.com/us-en/legal?lnk=flg-tous-usen" aria-label="Terms of Use">
                        Terms of Use
                      </a>
                    </li>
                    <li className={listItem}>
                      <a href="https://www.ibm.com/accessibility/us/en/?lnk=flg-acce-usen" aria-label="Accessibility">
                        Accessibility
                      </a>
                    </li>
              </ul>
