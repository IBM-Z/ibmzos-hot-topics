...
import NextPrevious from 'gatsby-theme-carbon/src/components/NextPrevious/NextPreviousStyles';
  ...
  const getPreviousItem = () => {
    ...
    if (prevCategory) {
      return {
        ...
        name: getName(prevCategory.title),
      };
    }
  ...
  const getNextItem = () => {
    ...
    if (nextCategory) {
      return {
        ...
        name: getName(nextCategory.title),
      };
    }
